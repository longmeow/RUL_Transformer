...
#Read dataset
train_df = pd.read_csv('/home/filtestbed/Documents/RUL_Transformer/RUL_raw_data/FD002/train_FD002.txt', sep=" ", header=None)
test_df = pd.read_csv('/home/filtestbed/Documents/RUL_Transformer/RUL_raw_data/FD002/test_FD002.txt', sep=" ", header=None)
truth_df = pd.read_csv('/home/filtestbed/Documents/RUL_Transformer/RUL_raw_data/FD002/RUL_FD002.txt', sep=" ", header=None)
...
train_df.to_csv('train_002.csv', encoding='utf-8', index=False)
test_df.to_csv('test_002.csv', encoding='utf-8', index=False)